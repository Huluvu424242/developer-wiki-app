...
- Diese Regel gilt ausdrücklich auch für längere Ruhe- oder **Sarkophag-Betriebsphasen** eines Projekts. Bleibt eine Lifecycle-Story beispielsweise über mehrere Jahre offen, wird sie nicht gelöscht, ersetzt oder quartalsweise dupliziert; jeder weitere Fälligkeitstermin wird datiert an derselben offenen Story dokumentiert.
