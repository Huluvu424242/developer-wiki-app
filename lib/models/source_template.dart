...
class SourceTemplate {
  ...
  bool get isImageSource =>
      fields.any((field) => field.kind == FieldKind.image);
...
const imageSourceTemplate = SourceTemplate(
  ...
  fields: [
    ...
    SourceField(
        id: 'description', label: 'Beschreibung', kind: FieldKind.textarea),
    SourceField(
        id: 'agent_notes',
  ...
  SourceTemplate(
    ...
    fields: [
      SourceField(
          ...
          required: true,
          placeholder: 'Open Knowledge Format Specification'),
      SourceField(
          id: 'urls',
          label: 'Link oder zusammengehörige Links',
          kind: FieldKind.textarea,
          required: true,
          placeholder: 'Pro Zeile eine vollständige URL'),
      SourceField(
          id: 'summary',
      ...
      SourceField(
          ...
          options: [
            'Webseite',
            'Dokumentation',
            'Spezifikation oder Standard',
            'Repository',
            'Artikel oder Blogbeitrag',
            'Video oder Podcast',
            'Wissenschaftliche Veröffentlichung',
            'Bild oder Screenshot',
            'Sonstige Linkquelle'
          ]),
      SourceField(
          id: 'language',
      ...
      SourceField(
          id: 'publisher',
          label: 'Herausgeber oder Plattform',
          kind: FieldKind.input,
          placeholder: 'GitHub'),
      SourceField(
          id: 'agent_notes',
      ...
      SourceField(
          id: 'authors',
          label: 'Autorinnen, Autoren oder verantwortliche Organisation',
          kind: FieldKind.input),
      SourceField(
          id: 'published',
          label: 'Veröffentlichungs- oder Aktualisierungsdatum',
          kind: FieldKind.input,
      ...
      SourceField(
          id: 'relevance',
          label: 'Relevanz für das Developer Wiki',
          kind: FieldKind.textarea),
      SourceField(
          id: 'image_content',
          label: 'Textinhalt oder Kernaussagen von Bildern',
          kind: FieldKind.textarea),
      SourceField(
          id: 'notes',
          label: 'Hinweise zu Zugriff und Auswertung',
          kind: FieldKind.textarea),
    ],
  ),
  SourceTemplate(
    ...
    description:
        'Eigene Notizen, Erfahrungswissen oder allgemeine Informationen.',
    fields: [
      SourceField(
          id: 'description',
          label: 'Beschreibung',
      ...
      SourceField(
          ...
          initialValue: agentInstruction),
      SourceField(
          id: 'topic', label: 'Thema oder Stichwörter', kind: FieldKind.input),
      SourceField(
          id: 'relevance',
          label: 'Zweck und Relevanz',
          kind: FieldKind.textarea),
      SourceField(
          id: 'sources',
          label: 'Quellen und weiterführende Links',
          kind: FieldKind.textarea),
      SourceField(
          id: 'target',
          label: 'Bezug zu bestehenden Wiki-Inhalten',
          kind: FieldKind.textarea),
      SourceField(
          id: 'certainty',
          label: 'Einschätzung der Information',
          kind: FieldKind.dropdown,
          options: [
            'Eigene Beobachtung oder Erfahrung',
            'Aus einer angegebenen Quelle übernommen',
            'Noch zu prüfen',
            'Unklar'
          ]),
      SourceField(
          id: 'notes', label: 'Weitere Hinweise', kind: FieldKind.textarea),
    ],
  ),
  SourceTemplate(
    id: 'public-person',
    ...
    fields: [
      SourceField(
          ...
          required: true),
      SourceField(
          id: 'person_group', label: 'Personenkreis', kind: FieldKind.input),
      SourceField(
          id: 'person_notes',
          label: 'Notizen und Stichpunkte zur Person',
          kind: FieldKind.textarea,
          required: true),
      SourceField(
          id: 'agent_notes',
