...
- [Entwicklungsumgebung und Android-Toolchain](development-environment.md) – Referenzversionen, Built-in-Kotlin-/AGP-9-Konfiguration, Flutter-kompatible DSL-Brücke, lokale Einrichtung und Prüfkommandos.
